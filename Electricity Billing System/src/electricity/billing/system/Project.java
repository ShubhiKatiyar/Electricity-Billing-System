        ...
        
{
    Project()
    {
        ...
        setSize(1920,1030);
        ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("electricity/billing/system/icon/back.jpg"));
        ...
        ImageIcon icon9=new ImageIcon(ClassLoader.getSystemResource("electricity/billing/system/icon/calc.jpg"));
